...
public class Person implements Cloneable {
    ...
    // Object 가 물려주는 toString 은 패키지 + 클래스 이름 + 주소값 -> 쓸 일이 잘 없다
    // 대부분 오버라이딩 해서 사용하는 편
    @Override
    ...
    @Override
    public int hashCode() {  // equals를 오버라이딩을 하려면 hashCode도 같이 오버라이딩을 하는 것을 권장
    ...
    protected void finalize() throws Throwable {
        ...
        // garbage collector 가 호출되는 순서를 보장할 수 없기 때문에 사용을 권장하지 않음
        super.finalize();
    }

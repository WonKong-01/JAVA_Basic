...
public class MethodExample3 {
    ...
    static void multi(int n1, int n2) { // void : return이 없는 메서드
        int result = n1 * n2;
    ...
    static void divide(int n1, int n2) {
        if (n2 == 0) {
            ...
            return;  // void 메서드 에서만 return 키워드 단독으로 가능 , 메서드내에서 사용하는 탈출 키워드
        }
        int result = n1 / n2;
    ...
    public static void main(String[] args) {
        ...
        // int r4 = multi(7, 11); (x)    return이 없는 void 메서드 이기 때문에 단독호출
        multi(7,11);
